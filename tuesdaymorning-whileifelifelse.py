...
def main():
    ...
    while True:
        ...
        if r.status_code == 200:
            ...
            # print(f"Timestamp - {issdata['timestamp']}") <- this technique will throw an ERROR if 'timestamp' does not exist
            print(f"Timestamp - {issdata.get('timestamp')}") # the .get method will return None if 'timestamp' does not exist
            # delay execution
            time.sleep(3.14)
